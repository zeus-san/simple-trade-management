...
class Menu_principal:
    def init(self):
        ...
        self.lista_pesquisa = []
        self.lista_compra = []
        self.colunas = ['id','nome','valor_venda','quantidade']
    ...
    def layout_tela(self):
        ...
        colunaMeio = [
                ...
                [sg.Table(self.lista_pesquisa,headings=self.titulos,key='-LISTA_PESQUISA-',size=(50,15),expand_x = True,enable_events=True)],#lista produtos
                [sg.Table([],headings=self.titulos_compra,size=(50,15),key='-LISTA_COMPRA-',expand_x = True,enable_events=True)],#lista compra
                [
        ...
        layout = [
                ...
                [sg.Button('OK',tooltip='Aperte aqui'), sg.Button("Fechar",key='Cancelar'),sg.Button("Configurações",key='configuracao')]
                ]
        return layout
    def execucao_tela_principal(self):
        ...
        event = None
        butoes_especiais = {'Casdastrar_pdt':Menu_cadastro().iniciar,'Atualizar_pdt':Menu_atualizar().iniciar}
        while True:
